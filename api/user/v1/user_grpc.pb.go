...
type UserClient interface {
	GetUserList(ctx context.Context, in *SearchUser, opts ...grpc.CallOption) (*UserListResponse, error)
...
func (c *userClient) GetUserList(ctx context.Context, in *SearchUser, opts ...grpc.CallOption) (*UserListResponse, error) {
...
func (c *userClient) GetUserByNickname(ctx context.Context, in *NicknameRequest, opts ...grpc.CallOption) (*UserInfoResponse, error) {
	out := new(UserInfoResponse)
	err := c.cc.Invoke(ctx, "/user.v1.User/GetUserByNickname", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) UpdateUser(ctx context.Context, in *UpdateUserInfo, opts ...grpc.CallOption) (*UpdateUserResponse, error) {
...
type UserServer interface {
	GetUserList(context.Context, *SearchUser) (*UserListResponse, error)
...
func (UnimplementedUserServer) GetUserList(context.Context, *SearchUser) (*UserListResponse, error) {
...
func (UnimplementedUserServer) UpdateUser(context.Context, *UpdateUserInfo) (*UpdateUserResponse, error) {
...
func _User_GetUserList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserList(ctx, req.(*SearchUser))
	}
...
func _User_GetUserByNickname_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.v1.User/GetUserByNickname",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
